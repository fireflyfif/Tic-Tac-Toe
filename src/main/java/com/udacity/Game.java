...
public class Game {
    ...
    /**
     * Performs the winner chack and displays a message if game is over
    ...
    public String checkGameWinner(char [][]grid){
        ...
        // Handle all wins
        if (xWins()) {
            // If the winner is 'x', update the String result to 'X wins'
            result = "X wins";
        } else if (oWins()) {
            // If the winner is 'x', update the String result to 'X wins'
            result = "O wins";
            ...
            if (freeSpots <= 0) {
                // If there is no winner, set the String result to 'Tie'
                result = "Tie";
            }
        }
        return result;
